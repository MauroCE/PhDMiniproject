...
# SETTINGS
pop = "growing"
path4w = paste("~/Documents/University/PhDMiniproject/snep_results_multiple_workers/growing_4w/")
path6w = paste("~/Documents/University/PhDMiniproject/snep_results_multiple_workers/growing_6w/")
path8w = paste("~/Documents/University/PhDMiniproject/snep_results_multiple_workers/growing_8w/")
...
read_results <- function(file_name, path){
...
tp6w <- read_results("theta_posterior_history", path6w)
