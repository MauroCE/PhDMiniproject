...
log_like_chunk <- function(i_start, i_end, params, isss=5000, pop="stable"){
  ...
  for (i in i_start:i_end){
    chunk_files[[i]] <- paste(pop, "/gtree_file", i, sep="")
  }
